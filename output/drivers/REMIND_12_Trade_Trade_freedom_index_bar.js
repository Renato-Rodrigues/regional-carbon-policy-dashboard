(function(){ 
        ...
        var gd = document.getElementById('REMIND_12_Trade_Trade_freedom_index_bar') 
  ...
  "data": [
    {
      ...
      "text": "Trade freedom index: 89.45 index (0-100)<br>REMIND_12 region code: CAZ<br>Countries in region: Canada; Australia; Christmas Island; Cocos (Keeling) Islands; Heard Island and McDonald Islands; New Zealand",
      "type": "bar",
      "textposition": "none",
      "marker": {
    ...
    },
    {
      ...
      "text": "Trade freedom index: 70.55 index (0-100)<br>REMIND_12 region code: REF<br>Countries in region: Russian Federation; Kazakhstan; Uzbekistan; Korea, Democratic People's Republic of; Tajikistan; Azerbaijan; Belarus; Turkmenistan; Kyrgyzstan; Mongolia; Armenia",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "x": [4],
      "y": [80],
      "text": "Trade freedom index: 80 index (0-100)<br>REMIND_12 region code: JPN<br>Countries in region: Japan",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "x": [6],
      "y": [69],
      "text": "Trade freedom index: 69 index (0-100)<br>REMIND_12 region code: IND<br>Countries in region: India",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "x": [11],
      "y": [80],
      "text": "Trade freedom index: 80 index (0-100)<br>REMIND_12 region code: USA<br>Countries in region: United States",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "x": [5],
      "y": [71.37995893240813],
      "text": "Trade freedom index: 71.38 index (0-100)<br>REMIND_12 region code: CHA<br>Countries in region: China; Taiwan, Province of China; Hong Kong; Macao",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
  ...
  "layout": {
    ...
    "title": {
      "text": "Trade freedom index (REMIND_12)",
      "font": {
        "color": "rgba(0,0,0,1)",
        "family": "",
  ...
  "cur_data": "b55c2e2d6e8a",
  "visdat": {
    "b55c2e2d6e8a": ["function (y) ", "x"],
    "b55c740a2f72": ["function (y) ", "x"]
  },
  "highlight": {
    "on": "plotly_click",
    "persistent": false,
