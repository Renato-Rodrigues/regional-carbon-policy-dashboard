(function(){ 
        ...
        var gd = document.getElementById('REMIND_12_Economy_Gini_index_bar') 
  ...
  "data": [
    {
      ...
      "x": [null],
      "y": [null],
      "text": "Gini index: NA index (0-100)<br>REMIND_12 region code: CAZ<br>Countries in region: Canada; Australia; Christmas Island; Cocos (Keeling) Islands; Heard Island and McDonald Islands; New Zealand",
      "type": "bar",
      "textposition": "none",
      "marker": {
    ...
    },
    {
      ...
      "text": "Gini index: 33.69 index (0-100)<br>REMIND_12 region code: REF<br>Countries in region: Russian Federation; Kazakhstan; Uzbekistan; Korea, Democratic People's Republic of; Tajikistan; Azerbaijan; Belarus; Turkmenistan; Kyrgyzstan; Mongolia; Armenia",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Gini index: 32.9 index (0-100)<br>REMIND_12 region code: JPN<br>Countries in region: Japan",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Gini index: 34.2 index (0-100)<br>REMIND_12 region code: IND<br>Countries in region: India",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Gini index: 39.8 index (0-100)<br>REMIND_12 region code: USA<br>Countries in region: United States",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Gini index: 37.1 index (0-100)<br>REMIND_12 region code: CHA<br>Countries in region: China; Taiwan, Province of China; Hong Kong; Macao",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
  ...
  "cur_data": "b55c69db6de2",
  "visdat": {
    "b55c69db6de2": ["function (y) ", "x"],
    "b55c63223d": ["function (y) ", "x"]
  },
  "highlight": {
    "on": "plotly_click",
    "persistent": false,
