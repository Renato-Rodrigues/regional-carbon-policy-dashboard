(function(){ 
        ...
        var gd = document.getElementById('REMIND_12_Trade_Trade_openness___exports_plus_imports_bar') 
  ...
  "data": [
    {
      ...
      "text": "Trade openness - exports plus imports: 52.67 % (GDP)<br>REMIND_12 region code: CAZ<br>Countries in region: Canada; Australia; Christmas Island; Cocos (Keeling) Islands; Heard Island and McDonald Islands; New Zealand",
      "type": "bar",
      "textposition": "none",
      "marker": {
    ...
    },
    {
      ...
      "text": "Trade openness - exports plus imports: 61.99 % (GDP)<br>REMIND_12 region code: REF<br>Countries in region: Russian Federation; Kazakhstan; Uzbekistan; Korea, Democratic People's Republic of; Tajikistan; Azerbaijan; Belarus; Turkmenistan; Kyrgyzstan; Mongolia; Armenia",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Trade openness - exports plus imports: 36.94 % (GDP)<br>REMIND_12 region code: JPN<br>Countries in region: Japan",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "base": 0,
      "x": [6],
      "y": [45.670000000000009],
      "text": "Trade openness - exports plus imports: 45.67 % (GDP)<br>REMIND_12 region code: IND<br>Countries in region: India",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "x": [11],
      "y": [25.48],
      "text": "Trade openness - exports plus imports: 25.48 % (GDP)<br>REMIND_12 region code: USA<br>Countries in region: United States",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Trade openness - exports plus imports: 39.27 % (GDP)<br>REMIND_12 region code: CHA<br>Countries in region: China; Taiwan, Province of China; Hong Kong; Macao",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
  ...
  "layout": {
    ...
    "title": {
      "text": "Trade openness - exports plus imports (REMIND_12)",
      "font": {
        "color": "rgba(0,0,0,1)",
        "family": "",
    ...
    "yaxis": {
      ...
      "tickmode": "array",
      "ticktext": ["0", "25", "50", "75"],
      "tickvals": [0, 25, 50.000000000000007, 75],
      "categoryorder": "array",
  ...
  "cur_data": "b55c646f4c89",
  "visdat": {
    "b55c646f4c89": ["function (y) ", "x"],
    "b55c7b675569": ["function (y) ", "x"]
  },
  "highlight": {
    "on": "plotly_click",
    "persistent": false,
