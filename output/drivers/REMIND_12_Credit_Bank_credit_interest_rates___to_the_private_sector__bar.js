(function(){ 
        ...
        var gd = document.getElementById('REMIND_12_Credit_Bank_credit_interest_rates___to_the_private_sector__bar') 
  ...
  "data": [
    {
      ...
      "text": "Bank credit interest rates - to the private sector : 3.75 % (?)<br>REMIND_12 region code: CAZ<br>Countries in region: Canada; Australia; Christmas Island; Cocos (Keeling) Islands; Heard Island and McDonald Islands; New Zealand",
      "type": "bar",
      "textposition": "none",
      "marker": {
    ...
    },
    {
      ...
      "x": [null],
      "y": [null],
      "text": "Bank credit interest rates - to the private sector : NA % (?)<br>REMIND_12 region code: REF<br>Countries in region: Russian Federation; Kazakhstan; Uzbekistan; Korea, Democratic People's Republic of; Tajikistan; Azerbaijan; Belarus; Turkmenistan; Kyrgyzstan; Mongolia; Armenia",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Bank credit interest rates - to the private sector : 0.99 % (?)<br>REMIND_12 region code: JPN<br>Countries in region: Japan",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Bank credit interest rates - to the private sector : 8.7 % (?)<br>REMIND_12 region code: IND<br>Countries in region: India",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Bank credit interest rates - to the private sector : 3.25 % (?)<br>REMIND_12 region code: USA<br>Countries in region: United States",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Bank credit interest rates - to the private sector : 4.35 % (?)<br>REMIND_12 region code: CHA<br>Countries in region: China; Taiwan, Province of China; Hong Kong; Macao",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
  ...
  "cur_data": "b55c3105520b",
  "visdat": {
    "b55c3105520b": ["function (y) ", "x"],
    "b55c6fa91953": ["function (y) ", "x"]
  },
  "highlight": {
    "on": "plotly_click",
    "persistent": false,
