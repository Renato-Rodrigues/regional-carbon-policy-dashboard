(function(){ 
        ...
        var gd = document.getElementById('REMIND_12_Government_Government_spending___percent_of_GDP_bar') 
  ...
  "data": [
    {
      ...
      "text": "Government spending - percent of GDP: 21.99 % (GDP)<br>REMIND_12 region code: CAZ<br>Countries in region: Canada; Australia; Christmas Island; Cocos (Keeling) Islands; Heard Island and McDonald Islands; New Zealand",
      "type": "bar",
      "textposition": "none",
      "marker": {
    ...
    },
    {
      ...
      "text": "Government spending - percent of GDP: 15.94 % (GDP)<br>REMIND_12 region code: REF<br>Countries in region: Russian Federation; Kazakhstan; Uzbekistan; Korea, Democratic People's Republic of; Tajikistan; Azerbaijan; Belarus; Turkmenistan; Kyrgyzstan; Mongolia; Armenia",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "x": [4],
      "y": [21.43],
      "text": "Government spending - percent of GDP: 21.43 % (GDP)<br>REMIND_12 region code: JPN<br>Countries in region: Japan",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "base": 0,
      "x": [6],
      "y": [11.190000000000001],
      "text": "Government spending - percent of GDP: 11.19 % (GDP)<br>REMIND_12 region code: IND<br>Countries in region: India",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Government spending - percent of GDP: 14.38 % (GDP)<br>REMIND_12 region code: USA<br>Countries in region: United States",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Government spending - percent of GDP: 15.8 % (GDP)<br>REMIND_12 region code: CHA<br>Countries in region: China; Taiwan, Province of China; Hong Kong; Macao",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
  ...
  "layout": {
    ...
    "title": {
      "text": "Government spending - percent of GDP (REMIND_12)",
      "font": {
        "color": "rgba(0,0,0,1)",
        "family": "",
  ...
  "cur_data": "b55c2863345",
  "visdat": {
    "b55c2863345": ["function (y) ", "x"],
    "b55c765a3949": ["function (y) ", "x"]
  },
  "highlight": {
    "on": "plotly_click",
    "persistent": false,
