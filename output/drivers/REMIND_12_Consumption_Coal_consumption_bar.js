(function(){ 
        ...
        var gd = document.getElementById('REMIND_12_Consumption_Coal_consumption_bar') 
  ...
  "data": [
    {
      ...
      "text": "Coal consumption: 54541.74 thousand short tons<br>REMIND_12 region code: CAZ<br>Countries in region: Canada; Australia; Christmas Island; Cocos (Keeling) Islands; Heard Island and McDonald Islands; New Zealand",
      "type": "bar",
      "textposition": "none",
      "marker": {
    ...
    },
    {
      ...
      "text": "Coal consumption: 153184.99 thousand short tons<br>REMIND_12 region code: REF<br>Countries in region: Russian Federation; Kazakhstan; Uzbekistan; Korea, Democratic People's Republic of; Tajikistan; Azerbaijan; Belarus; Turkmenistan; Kyrgyzstan; Mongolia; Armenia",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Coal consumption: 201874.58 thousand short tons<br>REMIND_12 region code: JPN<br>Countries in region: Japan",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "base": 0,
      "x": [6],
      "y": [1049851.0229191694],
      "text": "Coal consumption: 1049851.02 thousand short tons<br>REMIND_12 region code: IND<br>Countries in region: India",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "x": [11],
      "y": [548846.75],
      "text": "Coal consumption: 548846.75 thousand short tons<br>REMIND_12 region code: USA<br>Countries in region: United States",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "x": [5],
      "y": [4573098.711546584],
      "text": "Coal consumption: 4573098.71 thousand short tons<br>REMIND_12 region code: CHA<br>Countries in region: China; Taiwan, Province of China; Hong Kong; Macao",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
  ...
  "layout": {
    ...
    "title": {
      "text": "Coal consumption (REMIND_12)",
      "font": {
        "color": "rgba(0,0,0,1)",
        "family": "",
  ...
  "cur_data": "b55c7d997c88",
  "visdat": {
    "b55c7d997c88": ["function (y) ", "x"],
    "b55c3e0cefa": ["function (y) ", "x"]
  },
  "highlight": {
    "on": "plotly_click",
    "persistent": false,
