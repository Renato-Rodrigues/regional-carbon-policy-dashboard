(function(){ 
        ...
        var gd = document.getElementById('REMIND_12_Extraction_Cobalt_production_bar') 
  ...
  "data": [
    {
      ...
      "text": "Cobalt production: 3984.03 metric tons<br>REMIND_12 region code: CAZ<br>Countries in region: Canada; Australia; Christmas Island; Cocos (Keeling) Islands; Heard Island and McDonald Islands; New Zealand",
      "type": "bar",
      "textposition": "none",
      "marker": {
    ...
    },
    {
      ...
      "text": "Cobalt production: 3320.08 metric tons<br>REMIND_12 region code: REF<br>Countries in region: Russian Federation; Kazakhstan; Uzbekistan; Korea, Democratic People's Republic of; Tajikistan; Azerbaijan; Belarus; Turkmenistan; Kyrgyzstan; Mongolia; Armenia",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "x": [4],
      "y": [0],
      "text": "Cobalt production: 0 metric tons<br>REMIND_12 region code: JPN<br>Countries in region: Japan",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "x": [6],
      "y": [0],
      "text": "Cobalt production: 0 metric tons<br>REMIND_12 region code: IND<br>Countries in region: India",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Cobalt production: 500 metric tons<br>REMIND_12 region code: USA<br>Countries in region: United States",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "x": [5],
      "y": [2444.68744582728],
      "text": "Cobalt production: 2444.69 metric tons<br>REMIND_12 region code: CHA<br>Countries in region: China; Taiwan, Province of China; Hong Kong; Macao",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
  ...
  "layout": {
    ...
    "title": {
      "text": "Cobalt production (REMIND_12)",
      "font": {
        "color": "rgba(0,0,0,1)",
        "family": "",
  ...
  "cur_data": "b55ce247b2",
  "visdat": {
    "b55ce247b2": ["function (y) ", "x"],
    "b55c621e4a49": ["function (y) ", "x"]
  },
  "highlight": {
    "on": "plotly_click",
    "persistent": false,
