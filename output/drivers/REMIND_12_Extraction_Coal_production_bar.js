(function(){ 
        ...
        var gd = document.getElementById('REMIND_12_Extraction_Coal_production_bar') 
  ...
  "data": [
    {
      ...
      "x": [12],
      "y": [220790.305355171],
      "text": "Coal production: 220790.31 thousand short tons<br>REMIND_12 region code: CAZ<br>Countries in region: Canada; Australia; Christmas Island; Cocos (Keeling) Islands; Heard Island and McDonald Islands; New Zealand",
      "type": "bar",
      "textposition": "none",
      "marker": {
    ...
    },
    {
      ...
      "x": [3],
      "y": [263429.7002513762],
      "text": "Coal production: 263429.7 thousand short tons<br>REMIND_12 region code: REF<br>Countries in region: Russian Federation; Kazakhstan; Uzbekistan; Korea, Democratic People's Republic of; Tajikistan; Azerbaijan; Belarus; Turkmenistan; Kyrgyzstan; Mongolia; Armenia",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Coal production: 743.74 thousand short tons<br>REMIND_12 region code: JPN<br>Countries in region: Japan",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "x": [6],
      "y": [839961.2181610011],
      "text": "Coal production: 839961.22 thousand short tons<br>REMIND_12 region code: IND<br>Countries in region: India",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Coal production: 577361.31 thousand short tons<br>REMIND_12 region code: USA<br>Countries in region: United States",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
    ...
    },
    {
      ...
      "text": "Coal production: 4447503.5 thousand short tons<br>REMIND_12 region code: CHA<br>Countries in region: China; Taiwan, Province of China; Hong Kong; Macao",
      "type": "bar",
      "textposition": "none",
      "marker": {
        "autocolorscale": false,
  ...
  "layout": {
    ...
    "title": {
      "text": "Coal production (REMIND_12)",
      "font": {
        "color": "rgba(0,0,0,1)",
        "family": "",
  ...
  "cur_data": "b55c66ea77fa",
  "visdat": {
    "b55c66ea77fa": ["function (y) ", "x"],
    "b55c599d7a13": ["function (y) ", "x"]
  },
  "highlight": {
    "on": "plotly_click",
    "persistent": false,
